...
use crate::sundials::{sundials_nonlinearsolver::SUNNonlinearSolver, sundials_nvector::N_Vector, sundials_types::{SUNContext, sunrealtype}};
...
//                         void* user_data);
pub type IDAResFn = unsafe extern "C" fn(tt: sunrealtype, yy: N_Vector, yp: N_Vector, rr: N_Vector,
    user_data: *mut c_void) -> i32;

// typedef int (*IDARootFn)(sunrealtype t, N_Vector y, N_Vector yp,
//                          sunrealtype* gout_1d, void* user_data);
pub type IDARootFn = unsafe extern "C" fn(t: sunrealtype, y: N_Vector, yp: N_Vector,
    gout_1d: *mut sunrealtype, user_data: *mut c_void) -> i32;
...
pub unsafe fn IDACreate(sunctx: SUNContext) -> *mut c_void;
...
//                                     N_Vector abstol);
pub unsafe fn IDASVtolerances(ida_mem: *mut c_void, reltol: sunrealtype,
     abstol: N_Vector) -> i32;
...
pub unsafe fn IDASetNonlinearSolver(ida_mem: *mut c_void, NLS: SUNNonlinearSolver) -> i32;

// /* Rootfinding initialization function */

// SUNDIALS_EXPORT int IDARootInit(void* ida_mem, int nrtfn, IDARootFn g);
pub unsafe fn IDARootInit(ida_mem: *mut c_void, nrtfn: i32, g: IDARootFn) -> i32;
...
pub unsafe fn IDASolve(ida_mem: *mut c_void, tout: sunrealtype, tret: *mut sunrealtype,
        yret: N_Vector, ypret: N_Vector, itask: i32) -> i32;
...
pub unsafe fn IDAGetRootInfo(ida_mem: *mut c_void, rootsfound_1d: *mut i32) -> i32;
...
pub unsafe fn IDAFree(ida_mem: *mut *mut c_void);
